 ...
 * =============================================================================
 * 使得地图上能飘落各种天气粒子，天气粒子效果最多只能设置一个。
 * 【现已支持插件关联资源的打包、加密】
 *
 * -----------------------------------------------------------------------------
 * ----关联文件
 * 请先确保img文件夹下是否存在weather文件夹！（img/weather）
 ...
 * （注意：冒号两边都有一个空格。）
 *
 * 插件指令（设置）：weather : A : B : C : D
 * 插件指令（清除）：clear_weather
 *
 * 参数A：流动方式
 *        0 -  清风（落叶）
 *        1 -  清风（左侧吹动）
 ...
 *
 * 示例：
 * 插件指令：weather : 0 : 30 : 0 : 花瓣
 * 插件指令：weather : 6 : 80 : 1 : 光球3
 * 插件指令：clear_weather
 *
 * -----------------------------------------------------------------------------
 * ----关于Drill_up优化：
